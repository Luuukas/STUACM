<template>
  <div id="middle_block">
    <label v-if="this.$store.getters.getIsLogin" @click="upgMindMap">
      <div class="help-block" style="margin-bottom:1%">修改任何信息都需要点击保存
        <i class="layui-icon layui-icon-ok" style="font-size: large;margin: 5%"></i>
        </div>
    </label>
    <vD ref="viewD"></vD>
    <div
      id="mindmap_block"
      style="width:100%;height:120%;background-color: transparent;box-shadow:0px 0px 8px 5px #ccc;margin-bottom:1%"
    >
      <div ref="mindmap" class="hTree bar" style="overflow: scroll;height: 120%"></div>
    </div>
  </div>
</template>
